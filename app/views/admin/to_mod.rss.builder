...
xml.rss :version => "2.0" do
  xml.channel do
    xml.title "SSE QDB - ADMIN FEED"
    xml.description "The admin feed for the qdb"
    ...
    for quote in @quotes
      xml.item do
        ...
        xml.link "http://sse.se.rit.edu/qdb/quotes/#{quote.id}/edit"
        xml.guid "http://sse.se.rit.edu/qdb/quotes/#{quote.id}/edit"
      end
    end
  end
end